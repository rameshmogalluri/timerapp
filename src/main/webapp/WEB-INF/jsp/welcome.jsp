...
<%@ page import="com.google.appengine.api.blobstore.BlobstoreService,java.net.URLEncoder" %>

<%
    BlobstoreService blobstoreService = BlobstoreServiceFactory.getBlobstoreService();
    String successurl=URLEncoder.encode("/user/imageupload","UTF8");
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  ...
  %>
    ...
    <div class="maindiv">
       ...
       <div class="innerdiv">
       <div id="profilepic">
        <img alt="user photo" src="person-dummy.jpg" width="120px" height="120px" class="img-circle"> <br><br>
        <a href="" data-toggle="modal" data-target="#myModalprofilepic">Change Photo</a>
        </div>
       <br>
      ...
      <td>Mobile Number</td>
        ...
        <div style="margin-left:450px;margin-right:40px">
         ...
         <button type="button" class="btn btn-default" id="logout">LOGOUT</button> 
          <!-- profile pic -->
  <div class="modal fade" id="myModalprofilepic" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
           <form action="<%= blobstoreService.createUploadUrl(successurl)%>" method="post" enctype="multipart/form-data">
