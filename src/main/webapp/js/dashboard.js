...
document.querySelector("#profilepic").addEventListener("click",profile);
	document.body.addEventListener("click",function(event){var eventid=event.target.id;
if(!(eventid=="profilepic"||eventid=="menus"||eventid=="welcomename"))
	...
	var id=document.querySelector("#userid").value;
	  ...
	  function deactivate(){
	    ...
	    function main(){
	    	...
	    	document.getElementsByClassName("updateback")[0].style.display='inline-block';
	    	document.getElementsByClassName("updateback")[1].style.display='inline-block';
	    ...
	    function close() 
	      {
	    	...
	    	document.getElementsByClassName("updateback")[0].style.display='none';
	    	document.getElementsByClassName("updateback")[1].style.display='none';
	      }
	    function logout()
	    {
	    var xhr= new XMLHttpRequest();
